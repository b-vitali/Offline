...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef trkProton_ana_TProtonAna001Module_hh
#define trkProton_ana_TProtonAna001Module_hh
...
class TProtonAna001Module: public TStnModule {
public:
...
public:					// pointers to the data blocks used
  ...
  TStepPointMCBlock*   fVdetDataBlock;
...
//-----------------------------------------------------------------------------
public:
  TProtonAna001Module(const char* name="TriggerAna", const char* title="TriggerAna");
  ~TProtonAna001Module();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  ...
  ClassDef(TProtonAna001Module,0)
};
