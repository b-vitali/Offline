...
//
///////////////////////////////////////////////////////////////////////////////
#ifndef Stntuple_ana_TValidationModuleJJ_hh
#define Stntuple_ana_TValidationModuleJJ_hh
...
class TValidationModuleJJ: public TStnModule {
public:
...
//-----------------------------------------------------------------------------
public:
  TValidationModuleJJ(const char* name="ValidationJJ", const char* title="Validation");
  ~TValidationModuleJJ();
//-----------------------------------------------------------------------------
// accessors
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
  ...
  ClassDef(TValidationModuleJJ,0)
};
